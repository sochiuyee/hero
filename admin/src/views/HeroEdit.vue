      ...
      <el-tabs value="basic" type="border-card">
        <el-tab-pane label="基本信息" name="basic">
          ...
          <el-form-item label="banner">
            ...
            >
              <img v-if="model.banner" :src="model.banner" class="banner avatar"/>
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          ...
          <el-form-item label="使用技巧">
            <el-input type="text-area" v-model="model.usageTips"></el-input>
          </el-form-item>
          <el-form-item label="对抗技巧">
            <el-input type="text-area" v-model="model.battleTips"></el-input>
          </el-form-item>
          <el-form-item label="团战思路">
            <el-input type="text-area" v-model="model.teamTips"></el-input>
          </el-form-item>
        </el-tab-pane>
